    ...
    const markup = `
      <div style="width:${w}px;height:${h}px;display:flex;flex-direction:column;justify-content:space-between;position:relative;border:${6 * s}px solid #fff;box-sizing:border-box;overflow:hidden;color:#fff;">
        ...
        <div style="position:relative;display:flex;align-items:center;gap:${8 * s}px;padding:${28 * s}px ${28 * s}px 0;">
          ...
          <div style="font-family:Aileron;font-weight:700;font-size:${15 * s}px;text-transform:uppercase;letter-spacing:2px;background:rgba(0,0,0,0.55);padding:${4 * s}px ${8 * s}px;display:flex;">${label}</div>
        </div>
        <div style="position:relative;display:flex;align-items:flex-end;justify-content:space-between;gap:${16 * s}px;background:rgba(0,0,0,0.7);padding:${26 * s}px ${28 * s}px;">
          <div style="font-family:Aileron;font-weight:700;font-size:${42 * s}px;line-height:1.1;display:flex;max-width:78%;">${trimmed}</div>
          ${numBlock}
        </div>
      </div>
    `;
  ...
  const markup = `
    <div style="width:${w}px;height:${h}px;display:flex;flex-direction:column;justify-content:space-between;background:#000;border:${6 * s}px solid #fff;box-sizing:border-box;padding:${30 * s}px;color:#fff;">
      <div style="display:flex;align-items:center;gap:${8 * s}px;">
        <div style="width:${14 * s}px;height:${14 * s}px;background:${accent};display:flex;"></div>
        <div style="font-family:Aileron;font-weight:700;font-size:${15 * s}px;text-transform:uppercase;letter-spacing:2px;opacity:0.6;display:flex;">${label}</div>
      </div>
      <div style="display:flex;align-items:flex-end;justify-content:space-between;gap:${16 * s}px;">
        <div style="font-family:Aileron;font-weight:700;font-size:${48 * s}px;line-height:1.1;display:flex;max-width:78%;">${trimmed}</div>
        ${numBlock}
      </div>
    </div>
  `;
  ...
  const markup = `
    <div style="width:${w}px;height:${h}px;display:flex;flex-direction:column;justify-content:space-between;background:#000;border:${6 * s}px solid #fff;box-sizing:border-box;padding:${28 * s}px;">
      ...
      <div style="display:flex;align-items:flex-end;justify-content:space-between;">
        <div style="font-family:Aileron;font-weight:700;font-size:${260 * s}px;color:#fff;line-height:0.85;display:flex;">${num}</div>
    ...
    const markup = `
      <div style="width:${w}px;height:${h}px;display:flex;flex-direction:column;position:relative;border:${6 * s}px solid #fff;color:#fff;box-sizing:border-box;overflow:hidden;">
        ...
        <div style="position:relative;display:flex;padding:${40 * s}px ${52 * s}px 0;">
          <div style="font-family:Aileron;font-size:${20 * s}px;font-weight:700;letter-spacing:3px;background:rgba(0,0,0,0.55);padding:${4 * s}px ${8 * s}px;display:flex;">${site.toUpperCase()}</div>
        </div>
        <div style="position:relative;flex:1;display:flex;flex-direction:column;justify-content:flex-end;">
          <div style="display:flex;flex-direction:column;background:rgba(0,0,0,0.72);padding:${34 * s}px ${52 * s}px ${44 * s}px;">
            ...
            ${label ? `<div style="font-family:Aileron;font-size:${18 * s}px;font-weight:700;text-transform:uppercase;letter-spacing:2px;opacity:0.75;margin-bottom:${12 * s}px;display:flex;">${label}</div>` : ""}
  ...
  const markup = `
    <div style="width:${w}px;height:${h}px;display:flex;flex-direction:column;background:#000;border:${6 * s}px solid #fff;color:#fff;box-sizing:border-box;">
      <div style="display:flex;padding:${40 * s}px ${52 * s}px 0;">
        <div style="font-family:Aileron;font-size:${20 * s}px;font-weight:700;letter-spacing:3px;opacity:0.6;">${site.toUpperCase()}</div>
      </div>
      <div style="flex:1;display:flex;flex-direction:column;justify-content:flex-end;padding:0 ${52 * s}px ${44 * s}px;">
        <div style="height:${5 * s}px;width:100%;background:${accent};margin-bottom:${22 * s}px;display:flex;"></div>
        ${label ? `<div style="font-family:Aileron;font-size:${18 * s}px;font-weight:700;text-transform:uppercase;letter-spacing:2px;opacity:0.65;margin-bottom:${12 * s}px;display:flex;">${label}</div>` : ""}
        <div style="font-family:Aileron;font-size:${titleSize}px;font-weight:700;line-height:1.1;display:flex;margin-bottom:${14 * s}px;">${title}</div>
  ...
  const markup = `
    <div style="width:${w}px;height:${h}px;display:flex;position:relative;border:${6 * s}px solid #fff;box-sizing:border-box;overflow:hidden;color:#fff;">
      ...
      <div style="position:absolute;top:${28 * s}px;left:${28 * s}px;display:flex;align-items:center;gap:${8 * s}px;">
        <div style="width:${12 * s}px;height:${12 * s}px;background:${accent};display:flex;"></div>
        <div style="font-family:Aileron;font-size:${15 * s}px;font-weight:700;letter-spacing:2px;background:rgba(0,0,0,0.55);padding:${4 * s}px ${8 * s}px;display:flex;">${site.toUpperCase()}</div>
      </div>
